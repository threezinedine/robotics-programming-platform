...
namespace rpp
{
    static i32 s_glfwKeyMapping[KeyboardButton::KEYBOARD_BUTTON_COUNT] = {
        ...
        GLFW_KEY_9,
        GLFW_KEY_ESCAPE,
        INVALID_GLFW_KEY, // GLFW_KEY_LCTRL,
        INVALID_GLFW_KEY, // GLFW_KEY_LSHIFT,
        INVALID_GLFW_KEY, // GLFW_KEY_LALT,
        INVALID_GLFW_KEY, // GLFW_KEY_LSYSTEM,
        INVALID_GLFW_KEY, // GLFW_KEY_RCTRL,
        INVALID_GLFW_KEY, // GLFW_KEY_RSHIFT,
        INVALID_GLFW_KEY, // GLFW_KEY_RALT,
        INVALID_GLFW_KEY, // GLFW_KEY_RSYSTEM,
        GLFW_KEY_MENU,
        INVALID_GLFW_KEY, // GLFW_KEY_LBRACKET,
        INVALID_GLFW_KEY, // GLFW_KEY_RBRACKET,
        GLFW_KEY_SEMICOLON,
        GLFW_KEY_COMMA,
        GLFW_KEY_PERIOD,
        INVALID_GLFW_KEY, // GLFW_KEY_QUOTE,
        GLFW_KEY_SLASH,
        GLFW_KEY_BACKSLASH,
        INVALID_GLFW_KEY, // GLFW_KEY_TILDE,
        GLFW_KEY_EQUAL,
        INVALID_GLFW_KEY, // GLFW_KEY_DASH,
        GLFW_KEY_SPACE,
        INVALID_GLFW_KEY, // GLFW_KEY_RETURN,
        GLFW_KEY_BACKSPACE,
        GLFW_KEY_TAB,
        INVALID_GLFW_KEY, // GLFW_KEY_PAGEUP,
        INVALID_GLFW_KEY, // GLFW_KEY_PAGEDOWN,
        GLFW_KEY_END,
        GLFW_KEY_HOME,
        GLFW_KEY_INSERT,
        GLFW_KEY_DELETE,
        INVALID_GLFW_KEY, // GLFW_KEY_ADD,
        INVALID_GLFW_KEY, // GLFW_KEY_SUBTRACT,
        INVALID_GLFW_KEY, // GLFW_KEY_MULTIPLY,
        INVALID_GLFW_KEY, // GLFW_KEY_DIVIDE,
        GLFW_KEY_LEFT,
        GLFW_KEY_RIGHT,
        GLFW_KEY_UP,
        GLFW_KEY_DOWN,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD0,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD1,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD2,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD3,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD4,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD5,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD6,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD7,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD8,
        INVALID_GLFW_KEY, // GLFW_KEY_NUMPAD9,
        GLFW_KEY_F1,
        GLFW_KEY_F2,
        GLFW_KEY_F3,
        GLFW_KEY_F4,
