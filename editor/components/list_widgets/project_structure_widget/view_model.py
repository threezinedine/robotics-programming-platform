...
class ProjectStructureWidgetViewModel:
    def __init__(self, projectState: ProjectStateModel) -> None:
        ...
        self.openFunctionSignal = Signal()
        self.openFunctionSignal.Attach(self.OpenFunction)
    ...
    def OpenFunction(self, filePath: str) -> None:
        """
        ...
        logicWindow = GetObject(LogicWindow)

        logicWindow.showMaximized()
